...
const Blog1 = () => {
  const src = "https://media.licdn.com/dms/image/v2/D5612AQEXnxrZx2DYmQ/article-cover_image-shrink_720_1280/article-cover_image-shrink_720_1280/0/1722273329594?e=1735171200&v=beta&t=iUPz3TWmapDdcYPg_ye7Lw7TByw47qi_9Pz5k5yASzg";
  return (
    <div className="blog-container">
      ...
      <div className="blog-footer">
        <h3 className="blog-author">By Gaurav Agrawal</h3>
        <h3 className="blog-date">July 29, 2024</h3>
      </div>
    </div>
  );
};
