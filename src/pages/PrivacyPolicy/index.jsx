...
export default function PrivacyPolicy() {
 ...
 <div>
      ...
      <ul>
        ...
        <li>
          Application refers to ekai, the software program provided by the
          Company.
        </li>
        <li>
          Company (referred to as either "the Company", "We", "Us" or "Our" in
          this Agreement) refers to IDX Studios Inc., 38 smithe street,
          Vancouver, BC, Canada.
        </li>
        <li>Country refers to: British Columbia, Canada</li>
        <li>
      ...
      <ul>
        <li>By email: eekai@idxstudioz.com</li>
