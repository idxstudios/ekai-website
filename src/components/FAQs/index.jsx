    ...
    <div className="dropdown">
      ...
      {content.map((item, index) => (
        <div key={index}>
          ...
          {isOpen === index && (
            <>
              <p className="dropdown-content">{item.para}</p>
              {item.list && (
                <ul>
...
const content = [
  ...
  },
  {
    ...
    para: "Install via this link. If workplace policies restrict app installations, request permission from your Slack administrator.",
  },
  {
