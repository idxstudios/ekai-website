    ...
    <div className="EnhancingProductivity">
      <div className="Enhcontainer">
        ...
        <div className="three-container">
          <div className="box1">
            <Image loading="eager" priority={true} src={img1} alt="ekai" />
            <p>
          ...
          <div className="box2">
            <Image loading="eager" priority={true} src={img2} alt="ekai" />
            <p>
              Faster decision making by <br /> removing blockers
            </p>
          </div>
          <div className="box3">
            <Image loading="eager" priority={true} src={img3} alt="ekai" />
            <p>
