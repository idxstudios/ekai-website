...
// import video from "https://i.ibb.co/XsmmHTX/crossplatform.gif";
...
const card = [
    {
      isRev: false,
      gifSrc: "https://i.ibb.co/ZYn2KF6/realtime.png",
    ...
    {
      isRev: true,
      gifSrc: "https://i.ibb.co/XsmmHTX/crossplatform.gif",
    ...
    {
      isRev: false,
      gifSrc: 'https://i.ibb.co/XVZgw8d/compl-Updated.png',
